...
// Load library of paypal (No need to instantiate model)
...
module.exports = function () {
  ...
  const ShoppingCartController = setupShoppingCart(ShoppingCartModel);
  const OrderController = setupOrder(OrderDetailModel, OrderModel);
